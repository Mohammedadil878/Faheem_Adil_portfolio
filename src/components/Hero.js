...
import faheemImg from "../assets/faheem.jpg"
        ...
        <section className="flex min-h-screen flex-wrap items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1 }} className="w-full md:w-1/2 lg:p-8">
                <div className="flex justify-center">
                    <motion.img initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{  duration: 1 }} src={ faheemImg } alt="Faheem Adil" width={400} height={400} className="rounded-3xl" />
                </div>
            </motion.div>
        </section>
    )
